...
def generate_launch_description():
  ...
  ext_yaml = os.path.join(adi_tmc_coe_ros2_pkg_dir, 'config', '1slave_1axis.yaml')
  ...
  arg_tmc_base_name = DeclareLaunchArgument('tmc_base_name', default_value='tmcm_1461')
  tmc_base_name_ = LaunchConfiguration('tmc_base_name')

  arg_board_parent_frame = DeclareLaunchArgument('board_parent_frame', default_value='map')
  arg_board_base_name = DeclareLaunchArgument('board_base_name', default_value=[ns_prefix_,'/',tmc_base_name_,'_base_link'])
  ...
  # motor0 Arguments
  arg_mtr0_base_name = DeclareLaunchArgument('mtr0_base_name', default_value=[ns_prefix_,'/',tmc_base_name_,'_mtr0_frame'])
  ...
  tf_mtr0 = Node(
    package="tf2_ros",
    executable="static_transform_publisher",
    name=[tmc_base_name_,'_mtr0_link'],
    namespace=ns_prefix_,
    emulate_tty=True,
