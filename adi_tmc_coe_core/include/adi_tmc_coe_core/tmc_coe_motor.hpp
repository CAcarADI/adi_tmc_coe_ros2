...
#ifndef TMC_COE_MOTOR_HPP
#define TMC_COE_MOTOR_HPP
...
// Custom msg
#include "adi_tmc_coe_interfaces/msg/tmc_coe_info.hpp"

/* Available Modes of Operation */
typedef enum
{
  MODE_OF_OPERATION_NONE = 0,
  PROFILE_POSITION,
  PROFILE_VELOCITY = 3,
  HOMING_MODE = 6,
  CYCLIC_SYNC_POS = 8,
...
{
public:
  TmcCoeMotor(rclcpp::Node::SharedPtr p_node, TmcCoeInterpreter * p_tmc_coe_interpreter,
...
protected:
  ...
  void cmdTrqCallback(const std_msgs::msg::Int32::SharedPtr msg); // Not yet supported
